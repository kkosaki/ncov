...
if __name__ == '__main__':
    ...
    metadata.loc[(metadata.country == focal_country) & (metadata.country != focal_country), 'division_exposure'] = metadata.country_exposure
    metadata.loc[(metadata.country == focal_country) & (metadata.division_exposure.isna()), 'division_exposure'] = metadata.country
